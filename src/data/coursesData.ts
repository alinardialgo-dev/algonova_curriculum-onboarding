...
export const COURSES_DATA: Course[] = [
  // 1. CODING KNIGHT
  {
    ...
    ageRange: 'Usia 5-7 Tahun',
    minAge: 5,
    maxAge: 7,
    duration: '32 Pertemuan @ 45 menit',
    classSize: 'Private & Group (8 Orang)',
    difficulty: 'Pemula',
  ...
  // 2. DIGITAL LITERACY
  {
    ...
    ageRange: 'Usia 6–9 Tahun',
    minAge: 6,
    maxAge: 9,
    duration: '36 Pertemuan (60-90 Menit)',
    classSize: '8 (Group) / 1 (Private)',
  ...
  // 5. GRAPHIC DESIGN
  {
    ...
    ageRange: 'Usia 8–14 Tahun',
    minAge: 8,
    maxAge: 14,
    duration: '64 Pertemuan (Junior 1-32 / Senior 33-64)',
    classSize: 'Private & Group (1-10 Murid)',
    difficulty: 'Menengah - Sulit',
    language: 'English / Indonesia',
    shortDescription: 'Ubah imajinasi anak menjadi karya visual memukau. Dengan GIMP, Inkscape, TinkerCAD, dan Wick Editor, siswa membuat ilustrasi, model 3D, hingga animasi.',
    fullDescription: 'Perkenalan komprehensif dengan dunia desain profesional: grafik raster, ilustrasi vektor, tata letak majalah/buklet, pemodelan 3D, animasi gerak, dan perancangan portofolio web di Google Sites.',
    tools: ['GIMP', 'Inkscape', 'TinkerCAD', 'Scribus', 'Wick Editor', 'Google Sites', 'Canva'],
    finalProject: {
      title: 'Website Portofolio Digital Profesional',
      subtitle: 'Galeri Karya & Identitas Merek',
      description: 'Junior (Lesson 32): Portofolio galeri online karya desain terbaik. Senior (Lesson 64): Website Kartu Nama Profesional lengkap dengan identitas brand pribadi dan profil desainer.'
    },
    outcomes: [
      'Ilustrasi Raster & Vektor: Menguasai GIMP (layer, retouching) & Inkscape (Bezier, gradien, ikon)',
      'Model 3D & Ruang Spasial: TinkerCAD (primitive, hole, Scribble, tata letak 3D)',
      'Tata Letak Cetak & Infografis: Prinsip kedekatan, kontras, dan persiapan cetak',
      'Desain Gerak (Animasi): Wick Editor (frame-by-frame, tweening, animasi iklan)',
      'Brand Identity & Web Portfolio: Logo, identitas merek, dan publikasi di Google Sites'
    ],
    primaryFunctions: [
  ...
  // 6. PYTHON START
  {
    ...
    minAge: 12,
    maxAge: 15,
    duration: '68 Pertemuan (Tahun ke-1 & 2)',
    classSize: 'Private & Group (1-10 Murid)',
    difficulty: 'Menengah - Sulit',
    language: 'English / Indonesia',
  ...
  // 7. PYTHON PRO
  {
    ...
    minAge: 16,
    maxAge: 17,
    duration: '64 Pertemuan (Professional Career Path)',
    classSize: 'Private & Group (1-10 Murid)',
    difficulty: 'Sulit',
    language: 'English / Indonesia',
  ...
  // 8. MATH EXPLORER
  {
    ...
    ageRange: 'Usia 6–9 Tahun (TK B - 3 SD)',
    minAge: 6,
    maxAge: 9,
  ...
  // 9. MATH MASTER
  {
    ...
    ageRange: 'Usia 9–13 Tahun (4 SD - 6 SD)',
    minAge: 9,
    maxAge: 13,
    duration: '32 Pertemuan (60-90 Menit)',
    classSize: 'Private & Group (1-10 Murid)',
    ...
    fullDescription: 'Ikuti petualangan agen rahasia Ewen dan Odd! Math Master membawa siswa kelas 4-6 SD menjelajahi topik olimpiade matematika: Flexagon, Poliomino, Lingkaran Euler, Logika Linguistik, Futoshiki, Sandi Caesar, Jaring-jaring Kubus, dan Pertarungan Matematika.',
  ...
  // 10. MATH TUTORING (AI)
  {
    ...
    bgLight: 'bg-blue-50/50',
    textColor: 'text-blue-600',
    ageRange: 'Usia 6–17 Tahun',
    minAge: 6,
    maxAge: 17,
    duration: '40 Pertemuan Personal',
    classSize: '1-on-1 Private Tutoring',
    difficulty: 'Pemula - Menengah',
    language: 'English / Indonesia',
